...
const wrongLetterMessage = document.getElementById('wrong-letter-message');
const completedWordsList = document.getElementById('completed-words-list');
...
function showWrongLetterMessage() {
    if (wrongLetterMessage)
        wrongLetterMessage.classList.remove('hidden');
}
function hideWrongLetterMessage() {
    if (wrongLetterMessage)
        wrongLetterMessage.classList.add('hidden');
}
// Initialize the game
function initGame() {
